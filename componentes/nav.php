          ...
          <div class="container-fluid px-0">
            ...
            <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
              <ul class="navbar-nav navbar-nav-hover ms-auto">
                ...
                <li class="nav-item ms-lg-auto">
                  <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" href="lotes.php">
                    <span class="material-symbols-outlined opacity-6 me-1 text-xl">flag_circle</span>
                    Lotes
                  </a>
                </li>
                ...
                <li class="nav-item dropdown dropdown-hover ">
                  <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuPages"
                    ...
                    <span class="material-symbols-outlined opacity-6 me-1 text-xl">manufacturing</span>
